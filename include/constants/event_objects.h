...
#define OBJ_EVENT_GFX_FOLLOWER                   239

// NUM_OBJ_EVENT_GFX is 240; OBJ_EVENT_GFX_VARS no longer adds +1 so the
// dynamic VAR range 240-255 still fits in u8. See wiki for overworld expansion
// if more static IDs are needed beyond 239.
